...
public class Constructors {
	...
	public static void main(String[] args) {
		Constructors s1 = new Constructors("Abishek", 24, 'A','M', 77,79,89);
		Constructors s2 = new Constructors("Priya", 29, 'B','M', 0,56,65);
		Constructors s3 = new Constructors("Sathish", 21, 'A','M', 0,89,66);
		Constructors s4 = new Constructors("Santhosh", 24, 'B','F', 79,98,87);
